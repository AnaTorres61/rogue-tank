	...
	E-Mail: nxus@wxs.nl
	 Home: http://members.home.nl/hachmang/
	  Fonts: http://members.home.nl/hachmang/glitch/
      
          © past, present, future - Koen Hachmang
      _____________________________________
	      ______________________________________
	...
	- Installation and Use.
	  ...
	  of copies of the software product for personal
          use.

	  You may not install and use an unlimited number
	  of copies of the software product for commercial
          use unless by prior permission of the author.
	...
	3. MISCELLANEOUS
	  ...
	  Fonts for any reason, please mail to hachmang@home.nl